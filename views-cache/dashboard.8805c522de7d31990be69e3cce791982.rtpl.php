          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
              ...
              <div class="card-footer ">
                <hr>
                <div class="stats">
                  <i class="fa fa-refresh"></i> Tempo Real
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Favoritos</p>
              ...
              <div class="card-footer ">
                <hr>
                <div class="stats">
                  <button type="button" class="btn btn-secundary btn-round" data-toggle="modal" data-target="#fav">
                    <i style="color: aliceblue;" class="nc-icon nc-bullet-list-67"></i>Listar
                  </button> 
                </div>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <div class="card ">
              ...
              <div class="card-footer ">
                <hr>
                <div class="stats">
                  <i class="fa fa-history"></i><p data-time>Atualizado em: </p>
                </div>
              </div>
            </div>
          </div>
